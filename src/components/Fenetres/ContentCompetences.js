...
function ContentCompetences() {
  ...
  return (
    <div>
      <img alt="back arrow" style={{ height: "39px", margin: "10px", padding: '5px' }} src={"https://images.all-free-download.com/images/graphiclarge/back_button_37286.jpg"} onClick={() => { setFrontEnd(false); setBackEnd(false) }} />
      {!frontEnd && !backEnd && <div className="pdt_content2" >
        ...
        {selected2 ?
          <div className="pdt_fulldrive2" onClick={() => putSelected2()} style={{ border: "1px dotted black", backgroundColor: "lightblue", }} onDoubleClick={() => setBackEnd(true)}>
            <img
              className="pdt_drive"
              alt="drivepicture"
              src="https://icons.iconarchive.com/icons/dtafalonso/modern-xp/512/ModernXP-60-Disk-icon.png"
