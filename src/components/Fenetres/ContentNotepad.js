...
function ContentNotepad() {
  ...
  <br/>
        <p>
          {enTrue ? 'Initially graduated with a degree in management and marketing and 5 years in different marketing and sales positions, I decided to take a turn in my career in 2020 for new challenges.': "Initialement diplômé d'un master en management et marketing et 5 années dans différentes entreprises entre positions sales et marketing, j'ai décidé de me lancer dans une reconversion en 2020 à la recherche de nouveaux challenges."}
           </p>
          <br/>
  ...
  <p className="blinking" style={{display:"inline"}}>|</p></p>
        <br />
      </div>
    );
}

export default ContentNotepad
